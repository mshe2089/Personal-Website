    ...
    <div className="content">
      ...
      <div className="entry">
        ...
        <p className="paragraph">
          <br />Muqing, or Daniel. Failed actual engineer turned software engineer.
      ...
      <div className="entry">
        ...
        <p className="paragraph">
          ...
          <br />
          <br />This site is dynamic for no good reason, and self hosted on a Dell Inspiron 7590 Server.
          <br />
        </p>
        <br />
      </div>
      ...
      <div className="entry">
        ...
        <p className="paragraph">
          <br /><code>muqing.dev</code> domain: 42 AUD/year
          <br />
          <br />Electricity for the dell hosting the backend: ???
          <br />
        </p>
        <br />
      </div>
